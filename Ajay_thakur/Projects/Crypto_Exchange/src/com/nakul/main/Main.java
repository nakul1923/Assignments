...
import com.nakul.service.CoinService;
            ...
            if(choice1==1){
                ...
                if(choice2==1){            //to modify coins
                    ...
                    if(choice3==1){
                        ...
                        Coins coin = new Coins(name,symbol,price,quantity);
                        coinservice.addCoin(coin);

                        System.out.println("coin added success");
                    } else if(choice3==2){

                        System.out.println("Enter name of the coin you want to delete");
                        System.out.println("coin deleted success");
                    } else if(choice3==3){
                        System.out.println("Enter name of the coin you want to update: ");
                        String name = sc.nextLine();
                        System.out.println("Enter quantity of coin you want to add");
                        int quantity = sc.nextInt();
                        sc.nextLine();

                        coinservice.updateQuantity(name,quantity);
