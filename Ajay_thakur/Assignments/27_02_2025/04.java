...
import java.util.stream.Collectors;
 ...
 class Main{
     ...
     public static void main(String[] args) {
         ...
         l.add(new Student(104, "sandeep", 24, 38, "Bocm"));
         l.add(new Student(105, "Aashish", 23, 45, "MCA"));
         l.add(new Student(106, "Yashika", 20, 24, "Btech"));
         l.add(new Student(107, "Abhishek", 25, 95, "MBA"));
         l.add(new Student(108, "Yachika", 19, 35, "BCA"));
      

        List<String> w = l.stream().filter(x -> x.getMarks() < 40).map(x -> x.getName()).collect(Collectors.toList());

        System.out.println("Names of the failing Students are \n" + w);
